...
public partial class DouyinViewModel : ObservableObject
{
    ...
    public string DouyinQuickDownloadCookieStatusText => BuildDouyinCookieStatusText(Settings.CookieContent);
    ...
    private static string BuildDouyinCookieStatusText(string cookieContent)
    {
