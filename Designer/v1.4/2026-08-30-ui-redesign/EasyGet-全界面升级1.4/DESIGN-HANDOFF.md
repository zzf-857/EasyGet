# ad4dc52e-ead8-443a-9ab9-d0cc91f586eb implementation handoff

This archive is the source of truth for turning the design into production code. Start from `easyget-desktop-app.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `easyget-desktop-app.html`
...
- A single self-contained `easyget-desktop-app.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `easyget-desktop-app.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `easyget-desktop-app.html`
- `easyget-ui-redesign-v2.html`
- `easyget-ui-redesign.html`
...
- `brand-spec.md`
- `drawing-2026-08-30T11-50-47-495Z.png`
- `drawing-2026-08-30T12-22-47-378Z.png`

## Coding checklist for AI tools
1. Inspect `easyget-desktop-app.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
