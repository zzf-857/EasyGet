...
### 🎨 用户体验
- **VibeTracker Calm Apple Dark** 现代化深色主题，采用精细调配的语义化 Token、窄侧栏设计、玻璃材质面板以及全套控件圆角和微妙动效
...
- [x] 按平台自动归类保存
- [x] 抖音浏览器兜底下载
- [x] VibeTracker Calm Apple Dark 暗色主题
- [x] 全局异常捕获 + 崩溃日志
- [x] JSON 配置持久化
- [x] 窗口位置 / 大小持久化
- [x] 日志自动滚动到底部
...
- [x] 全面覆盖 213 个单元测试（覆盖 ViewModel、命令、XAML 结构断言及快捷键检测）
