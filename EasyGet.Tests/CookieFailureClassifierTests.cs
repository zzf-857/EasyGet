...
public sealed class CookieFailureClassifierTests
{
    ...
    [InlineData("generic", "指定状态下使用的密钥无效", CookieFailureCategory.CookieDecryptFailed, true)]
    [InlineData("generic", "数据无效", CookieFailureCategory.CookieDecryptFailed, true)]
    [InlineData("generic", "The data is invalid", CookieFailureCategory.CookieDecryptFailed, true)]
    [InlineData("generic", "Private video", CookieFailureCategory.AuthenticationRequired, true)]
    [InlineData("generic", "This video is members-only", CookieFailureCategory.AuthenticationRequired, true)]
    [InlineData("generic", "HTTP Error 401", CookieFailureCategory.AuthenticationRequired, true)]
    [InlineData("generic", "Unauthorized", CookieFailureCategory.AuthenticationRequired, true)]
