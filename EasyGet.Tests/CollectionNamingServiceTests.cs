...
public class CollectionNamingServiceTests
{
    ...
    [Fact]
    public void BuildItemTitle_StripsBilibiliCollectionTitleAndAddsCollectionSequence()
    {
        var resolvedTitle =
        ...
        Assert.Equal("01. 00.【RAG知识库搭建学习指南】从理论导实战的完整路径", title);
    }

    [Fact]
    public void BuildItemTitle_AddsCollectionSequenceBeforeOriginalEntryNumber()
    {
        ...
        Assert.Equal("02. 01.【RAG核心原理】RAG的使用场景", title);
    }
    ...
    [Theory]
    [InlineData(10, "10 分钟讲透 Kubernetes", "10. 10 分钟讲透 Kubernetes")]
    [InlineData(11, "10.彻底搞懂 K8s Helm", "11. 10.彻底搞懂 K8s Helm")]
    public void BuildItemTitle_AddsCollectionSequenceWhenOriginalTitleStartsWithNumber(
        int oneBasedIndex,
